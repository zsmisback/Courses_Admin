                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseComments" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
								...
								<!--
                                    ...
                                    <a class="nav-link" href="admin.php?action=viewcomments">List lesson comments</a>
									<a class="nav-link" href="admin.php?action=viewblogcomments">List blog comments</a>
                                </nav>
							</div> 
