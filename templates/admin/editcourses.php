<?php include 'header.php'; ?>
                        ...
                        <form method = "post" enctype="multipart/form-data">
										<input type='hidden' name='course_id' value='<?php echo $_GET['course_id']; ?>' />
											...
											Course Price(Leave empty if its free):
											<input class="form-control py-4" id="inputLastName" type="text" placeholder="Rs." name="course_price" value="<?php echo $results['courses']->course_price; ?>"/>
