						...
						<p class='error'><?php echo $error; ?></p>
										<input type='hidden' name='course_id' value='<?php echo $_GET['course_id']; ?>' />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control py-4" id="inputEmailAddress" type="text" name="course_summary" maxlength="200" placeholder="Enter course summary"><?php echo $results['courses']->course_summary; ?></textarea>
                                            </div>
