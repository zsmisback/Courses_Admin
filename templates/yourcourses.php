          ...
          <div class="col-md-6 col-lg-8 order-md-2">
			...
			foreach($results['your_courses'] as $your_courses)
			{
              echo"<div class='col-md-12 col-lg-6 mb-5'>
                <div class='block-19'>
                  <figure>
                    <a href='.?action=yourlessons&course_id=$your_courses->course_id'><img src='Profilepics/Courses/thumb/$your_courses->course_id$your_courses->course_image' alt='Image' class='img-fluid'></a>
                  </figure>
                    <div class='text'>
