      ...
      <div class="row">
		...
		echo  "<li class='mb-3'><a href='../index.php?action=home' style='color:white;' class='quick'>Home</a></li>";
			...
			else
			{
                ...
                <li class='mb-3'><a href='../index.php?action=terms' style='color:white;' class='quick'>Terms & Conditions</a></li>
				<li class='mb-3'><a href='../index.php?action=privacy' style='color:white;' class='quick'>Privacy Policy</a></li>
              </ul>
            </div>
